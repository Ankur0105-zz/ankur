...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(references, name)) {
        var exprSignal = $as_Lcalculator_Signal(references.apply__O__O(name));
        expr = $as_Lcalculator_Expr(exprSignal.apply__O());
        continue _eval
      } else {
        return (NaN)
      }
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2) {
    return (function() {
      return (2 * $uD(a$2.apply__O()))
    })
  })(a));
  var twiceA = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(b$2) {
    return (function() {
      return (-$uD(b$2.apply__O()))
    })
  })(b));
  var negB = new $c_Lcalculator_Signal().init___F0(expr$1);
  $m_Lcalculator_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1) {
    return (function() {
      var a$1 = $uD(delta$1.apply__O());
      return $uD($g["Math"]["sqrt"](a$1))
    })
  })(delta));
  var srtDelta = new $c_Lcalculator_Signal().init___F0(expr$2);
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1$1, twiceA$1, negB$1, srtDelta$1) {
    return (function() {
      if (($uD(delta$1$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(($uD(negB$1.apply__O()) + $uD(srtDelta$1.apply__O())) / $uD(twiceA$1.apply__O())), (($uD(negB$1.apply__O()) - $uD(srtDelta$1.apply__O())) / $uD(twiceA$1.apply__O()))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var bValue = $uD(b$1.apply__O());
      return ((bValue * bValue) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, b, c));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var signal = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, str$1, signal$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(signal$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(str$1)))
      })
    })(this, str, signal));
    return new $c_T2().init___O__O(str, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
